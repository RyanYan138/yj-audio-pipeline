...
# FunASR Nano 用自己的 env（funasr_nano），其他步骤用 emilia_pipe_clean
_FUNASR_ENV_LIB=/Work21/2025/yanjiahao/conda-envs/funasr_nano/lib/python3.10/site-packages/nvidia
export LD_LIBRARY_PATH="${_FUNASR_ENV_LIB}/cudnn/lib:${_FUNASR_ENV_LIB}/cublas/lib:${LD_LIBRARY_PATH}"

############################################
# FireRedVAD + FunASR Nano
# VAD: 小红书 FireRedVAD
# ASR: FunASR Nano（funasr_nano conda env）
############################################
